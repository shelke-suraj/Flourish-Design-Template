      ...
      <div className="container-fluid justify-content-between">
        ...
        <div className="d-flex align-items-center end-block">
          ...
          <button className="nav-button theme-button" id="theme_toggle" onClick={toggleTheme}>
            <svg xmlns="http://www.w3.org/2000/svg" className={`svgs theme-svg ${isRotated ? "rotated" : "rotated"}`} fill="var(--nav-bar-text-color)" x="0px" y="0px" width="35" height="35" viewBox="0 0 32 32">
